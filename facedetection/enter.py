            ...
            with CameraInference(face_detection.model()) as inference:
                ...
                for result in inference.run(args.num_frames):
                    ...
                    for face in faces:
                        ...
                        if(args.region[0] <= face.bounding_box[0] and \
                           args.region[0] + args.region[2] >= face.bounding_box[0] + face.bounding_box[2] and \
                           args.region[1] <= face.bounding_box[1] and \
                           args.region[1] + args.region[3] >= face.bounding_box[1] + face.bounding_box[3]):
